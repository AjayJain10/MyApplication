...
import com.example.ajayj.myapplication.LoginActivity;
import com.example.ajayj.myapplication.MainActivity;
...
public class BlankFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        floginbtn= (Button) view.findViewById(R.id.floginbtn2);
